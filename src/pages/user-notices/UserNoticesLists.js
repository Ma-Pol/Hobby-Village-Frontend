  ...
  useEffect(() => {
    ...
    // 검색 조건이 있을 때
      ...
      axios
        .all([
          axios.get(
            `/notices/count?condition=${searchParams.get(
              'condition'
    ...
    <Container sx={{ minHeight: '80vh', userSelect: 'none' }}>
      ...
      >
        ...
        >
          ...
          <Grid item xs={1}>
            <Typography sx={tableHead}>조회수</Typography>
          </Grid>
        </Grid>
...
export default UserNoticesLists;
